...
import {
  PlasmicTag,
  DefaultTagProps
} from "./plasmic/portfolio_revamp/PlasmicTag";
...
export interface TagProps extends DefaultTagProps {}

function Tag_(props: TagProps, ref: HTMLElementRefOf<"div">) {
  ...
  return <PlasmicTag tagContainer={{ ref }} {...props} />;
}
